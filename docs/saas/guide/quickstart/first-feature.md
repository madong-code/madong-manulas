...
前端 template/mono/apps/admin/src/
...
`template/mono/apps/admin/src/api/goods/category/types.ts`
...
`template/mono/apps/admin/src/api/goods/category/index.ts`
...
`template/mono/apps/admin/src/views/goods/category/schemas/index.tsx`
...
`template/mono/apps/admin/src/views/goods/category/index.vue`
...
`template/mono/apps/admin/src/lang/zh-CN/goods.json`
