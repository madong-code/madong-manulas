...
- `template/mono/apps/admin/dist` → `backend/public/admin`
- `template/mono/apps/platform/dist` → `backend/public/platform`
- `template/web/.output/public` → `backend/public/web`（Nuxt 当前 `ssr:false`，仅静态）
- `template/mono/apps/install/dist` → `backend/public/install`
